...
function Hilitor(id, tag)
{
  ...
  // recursively apply word backlighting
  ...
  // start backlighting at target node
...
var hiliObject = new Hilitor("content");

function backlight() {
  var search = document.getElementById("searchwords").value;
  if (search.length > 0) hiliObject.apply(search)
  else removebacklight();
